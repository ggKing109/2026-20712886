...
//vtkSmartPointer<vtkActor> ModelPart::getActor() {
    /* This iint ModelPart::getR() const { return m_r; }
int ModelPart::getG() const { return m_g; }
int ModelPart::getB() const { return m_b; }

void ModelPart::setR(int r) { m_r = r; }
void ModelPart::setG(int g) { m_g = g; }
void ModelPart::setB(int b) { m_b = b; }s a placeholder function that you will need to modify if you want to use it */
